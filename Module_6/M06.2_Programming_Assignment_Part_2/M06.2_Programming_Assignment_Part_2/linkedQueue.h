...
private:
    nodeTypeQueue<Type> *queueFront; //pointer to the front of 
                                //the queue
    nodeTypeQueue<Type> *queueRear;  //pointer to the rear of 
                                //the queue
};
...
{
    nodeTypeQueue<Type> *newNode;

    newNode = new nodeTypeQueue<Type>;   //create the node
